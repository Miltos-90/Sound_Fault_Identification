...
def hertz2mel(frequency: np.array):
    """
...
def melFilterbank(
    numDFTbins: int, numFilters: int, sampleFrequency: int=44000, normalize: bool=True
):
    """
