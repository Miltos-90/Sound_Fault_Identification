...
def tqdmJoblib(tqdm_object):
    """ Context manager to patch joblib to report into tqdm progress bar given as argument.
        Useful when features have to be extracted from multiple files in one go and in parallel.

        Rerefence: https://stackoverflow.com/questions/24983493/tracking-progress-of-joblib-parallel-execution/58936697 
    """
...
def extract(
    ...
    """
    Feature extraction from raw audio signals [1]. The raw signals are split
