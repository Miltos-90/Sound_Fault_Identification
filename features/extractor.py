...
def makeFeatures(
   ...
   ===============================
    ...
    NOTE: The peakFinder() function returns nans if less than <numHarmonics> peaks are found.
    """
    ...
    poweramps     = pre.spectra.psd(amps, fs)
    ...
    # Evaluate all features along the spectral axis
