...
def _spread(specificLoudness: np.array, totalLoudness: np.array, axis: int) -> np.array:
    """ Computes acoustic spread, i.e.e the distance between the largest specific loudness
        ...
        Outputs:
            spread: Acoustic spread array. It's dimensions match the dimensions of the 
